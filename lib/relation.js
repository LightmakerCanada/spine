...
(function() {
  var Collection, Instance, Singleton, Spine, association, isArray, requireModel, singularize, underscore,
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.fetch = function(params, options) {
      ...
      return typeof (_base = this.model).ajax === "function" ? _base.ajax().fetch(params, options) : void 0;
    };
