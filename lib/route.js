...
(function() {
  ...
  Route = (function(superClass) {
    ...
    Route.setup = function(options) {
      ...
      if (this.history) {
        ...
        $(window).on('hashchange', this.change);
      }
      return this.change();
    };
    ...
    Route.off = function() {
      ...
      if (this.history) {
        return $(window).off('popstate', this.change);
      } else {
        return $(window).off('hashchange', this.change);
      }
    };
  ...
  Route.prototype.unbind = Route.prototype.off;
