...
(function() {
  ...
  Model = (function(superClass) {
    ...
    Model.prototype.changes = function() {
      var changed, changes, j, key, len, ref;
      changed = false;
      changes = {
        before: {},
        after: {}
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        if ((this.root()[key] != null) && JSON.stringify(this.root()[key]) === JSON.stringify(this[key])) {
          continue;
        }
        changed = true;
        changes.before[key] = this.root()[key];
        changes.after[key] = this[key];
      }
      if (!changed) {
        return;
      }
    ...
    Model.prototype.refresh = function(atts) {
      ...
      clone = this === this.root() ? this.clone() : this;
      clone.load(atts);
    ...
    Model.prototype.root = function() {
      return this.constructor.irecords[this.id];
    };
    ...
    Model.prototype.update = function(options) {
      ...
      this.root().load(this.attributes());
  ...
  Controller = (function(superClass) {
    ...
    Controller.prototype.delegateEvents = function(events) {
      ...
      for (key in events) {
        ...
        selector = match[2];
        if (selector === '') {
          results.push(this.el.on(eventName, method));
        } else {
